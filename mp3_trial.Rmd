...
The fourth data graphic depicts the buffer of half a mile originating from the parking lot - indicating that onr of the campsites is outside the buffer and another campsite is near the end of the buffer. The actual walk from the parking lot will be longer than half a mile since the trails are not straight. 
...
Actual evidence that we were here!!! :DDD 
